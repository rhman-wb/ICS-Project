...
public class CreateProductRequest {
    ...
    @Schema(description = "产品名称", example = "中国人寿财产保险股份有限公司西藏自治区中央财政补贴型羊养殖保险", requiredMode = Schema.RequiredMode.REQUIRED)
    private String productName;

    /**
     * 报送类型
     */
    @NotBlank(message = "报送类型不能为空")
    @Schema(description = "报送类型", example = "修订产品", allowableValues = {"新产品", "修订产品"}, requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "产品类型", example = "AGRICULTURAL", allowableValues = {"AGRICULTURAL", "FILING"}, requiredMode = Schema.RequiredMode.REQUIRED)
